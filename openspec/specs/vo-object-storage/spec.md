...
Define the backend-only Alibaba Cloud OSS storage boundary for isolated object save, explicit restore, metadata, listing, overwrite, deletion, bounded-memory transfer, safe failures, and active-configuration use.
