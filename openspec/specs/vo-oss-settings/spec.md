...
Define application-managed Alibaba Cloud OSS settings, write-only credential handling, endpoint-derived region selection, explicit connection testing, persistence, and atomic activation for subsequent storage operations.
