# project-completion-reporting Specification

## Purpose

Define project-scoped Feishu completion reporting from eligible final business artifacts, including delivery fallback, observable delivery state, and safe recovery.
