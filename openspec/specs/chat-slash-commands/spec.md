...
Define the exact `/new` and `/compact` control-message behavior across Virtual Office and Feishu chat surfaces, including scope isolation, Provider capabilities, feedback, persistence, and compatibility.
