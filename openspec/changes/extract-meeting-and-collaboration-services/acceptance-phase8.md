...
- `tests/meeting_phase8_acceptance.py`: passed health, management authorization denial, Meeting creation/intervention/agenda/terminalization, recovery and occupancy cleanup, request confirmation and atomic conversion, Project resume, action-item task conversion, and missing-webhook notification degradation.
