...
| Artifact — escape rejection | Explicit absolute-root validation, realpath containment, no-follow/fstat, root-inode verification, associated-only policy | Missing/relative-root, traversal, file/root symlink-swap, non-regular-file, limit tests |
...
| API/event/storage compatibility | Thin HTTP adapters and Markdown store preserved | Full 511 Python, 23 JavaScript, workflow, SSE/WebSocket, notification suites |
