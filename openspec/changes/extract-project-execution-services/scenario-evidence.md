...
| Artifact — escape rejection | Realpath containment, no-follow/fstat, associated-only policy | Traversal, symlink-swap, non-regular-file, limit tests |
...
| API/event/storage compatibility | Thin HTTP adapters and Markdown store preserved | Full 504 Python, 23 JavaScript, workflow, SSE/WebSocket, notification suites |
