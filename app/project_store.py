...
class MarkdownProjectStore:
    ...
    def _write_project(self, project: Dict[str, Any]):
        ...
        meta = {
            ...
            "feishuCompletionReportEnabled": project.get("feishuCompletionReportEnabled", True),
    ...
    def _read_project_dir(self, project_dir: str) -> Dict[str, Any]:
        ...
        project = {
            ...
            "feishuCompletionReportEnabled": meta.get("feishuCompletionReportEnabled", True) is not False,
