...
| `VO_CHAT_SLASH_COMMANDS_ENABLED` | `true` | VO 聊天中的精确 `/new`、`/compact` 命令；可显式设为 `false` 关闭 |
| `VO_FEISHU_CHAT_SLASH_COMMANDS_ENABLED` | `false` | 在 VO slash 命令启用后，再启用飞书私聊和提及门禁群聊命令 |
