...
- Artifact reads/deletes reject missing or relative roots, traversal, symlink swaps, non-regular files, unassociated paths, and resource-limit abuse; an invalid context can never fall back to the process working directory.
