#!/usr/bin/env python3
"""HTTP end-to-end coverage for Codex live activity and controls."""
...
def run():
    with tempfile.TemporaryDirectory(prefix="vo-codex-live-activity-e2e-") as tmp:
        port = free_port()
        ws_port = free_port()
        env = os.environ.copy()
        ...
        with open(config_path, "w") as config_file:
            json.dump({
                "office": {"name": "Codex Live Activity E2E"},
