...
assert(source.includes("managementAccessHandler"));
assert(source.includes(": await requestManagementToken()"), 'legacy pages should retain the on-demand prompt fallback');
