...
assert.ok(review.includes("method: 'PUT'"));
assert.ok(review.includes("/confirm`"));
assert.ok(review.includes("/reject`"));
assert.ok(review.includes('expectedRevision'));
assert.ok(review.includes('confirmationKey'));
assert.ok(review.includes('state.pendingActions.has(request.id)'));
assert.ok(review.includes('ProjectAuthoringReview.saveEdit()'));
assert.ok(review.includes('ProjectAuthoringReview.confirm()'));
assert.ok(review.includes('ProjectAuthoringReview.reject()'));
assert.ok(review.includes('openCreatedProject'));
assert.ok(review.includes('window.ProjMgr.openProject(state.createdProject.id)'));
