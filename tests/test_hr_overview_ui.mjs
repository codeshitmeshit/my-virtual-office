...
const prioritized = helpers.prioritizeAgents([
  { ai_id: 'ready', status: 'active', availability: 'available' },
  { ai_id: 'failed', status: 'disabled', availability: 'unavailable' },
  { ai_id: 'pending', status: 'active', availability: 'available' },
]);
