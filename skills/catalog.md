...
- `/skills/vo-operating-guidelines/SKILL.md`
...
- `/skills/vo-agent-directory/SKILL.md`
- `/skills/vo-project-authoring/SKILL.md`
- `/skills/vo-project-workflow/SKILL.md`
- `/skills/vo-meeting-execution/SKILL.md`

Use the current local `VO_BASE_URL` when building full URLs. Do not hardcode or disclose external deployment addresses.
